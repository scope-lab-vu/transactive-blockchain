...
#include "RIAPS_Sim_Int.h"             /* Model's header file */
#include "rtwtypes.h"
...
void rt_OneStep(void)
{
  ...
  /* '<Root>/InstEng' */
  static real_T arg_InstEng = 0.0;

  /* '<Root>/AggrEng' */
  static real_T arg_AggrEng;
  ...
  /* Step the model */
  arg_AggrEng = RIAPS_Sim_Int_step(arg_InstEng);
