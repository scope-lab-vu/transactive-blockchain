...
\conferenceinfo{IoT 2017,}{October 22--25, 2017, Linz, Austria}
\isbn{978-1-4503-5318-2/17/10}\acmPrice{\$15.00}
...
grid.  This paper describes \emph{Privacy-preserving
    Energy Transactions} (PETra), which is a secure and safe solution
for transactive microgrids that enables consumers to trade energy
without sacrificing their privacy.  PETra
...
\ccsdesc[300]{Hardware~Energy distribution}
