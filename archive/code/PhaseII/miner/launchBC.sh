...
$DIR/geth-linux-amd64/geth account new --password password.txt --datadir prosumers/

##

#$DIR/geth-linux-amd64/geth --datadir eth/  init genesis-data.json

$DIR/geth-linux-amd64/geth --datadir miner0/  init genesis-data.json
cp -r miner0 miner1
cp -r miner0 prosumers
$DIR/geth-linux-amd64/geth --datadir miner1/  init genesis-data.json
$DIR/geth-linux-amd64/geth --datadir prosumers/  init genesis-data.json
#$DIR/geth-linux-amd64/geth account new --password password.txt --datadir prosumers/
