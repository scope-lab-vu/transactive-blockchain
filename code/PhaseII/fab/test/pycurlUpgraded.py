...
def addPeer():
    results = rpcCommand(port=9012,method="admin_addPeer",params=["enode://bbdc9c7dd86c517793ea7fb227ae05339bf92f9264b3be30dfae34bff7bf4360bc0fa43b818b650b93af2b23fef0843542b0b00d0cd6e26dd0519e997f0c492b@[::]:8017"])
#    peerEnode = results['enode']
    print(results)
#    print ("\n\n")
#    print(str(peerEnode))
...
#    getEnode()
    #getEnodeInfo()
    getEnodeInfo(ip=sys.argv[1],port=sys.argv[2])
