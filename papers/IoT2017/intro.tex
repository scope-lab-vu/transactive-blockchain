...
\todo{Lets call this system is PETra - Privacy preserving Energy Transactions}
...
\item \textbf{Leakage of Energy Usage Patterns to Other Prosumenrs} \Doug{Abhishek, can you please add a pithy summary of this challenge?}
...
\item \textbf{Preventing Inference of Future State of a Prosumer} \Doug{Abhishek, can you please add a pithy summary of this challenge?}
 \Abhishek{Is this not
...
\item \textbf{Preventing Personally Identifiable Information} \Doug{Abhishek, can you please add a pithy summary of this challenge?}
...
%  connect the paper and our work back to IoT in this paragraph.}  
  %This
%paper proposes a solution that (1) enables trading energy futures in a
%secure and verifiable manner, (2) preserves prosumer privacy, and (3)
%enables DSOs to regulate the trading platform and enforce certain
%safety rules. 
 %\Aron{Since SIGCHI does not have section numbers, this
 % paragraph, which describes the organization of the paper, is not
  %very clear.}  

%\Abhishek{I have commented the previous because it seems redundant}
