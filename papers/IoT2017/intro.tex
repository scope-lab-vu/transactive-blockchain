...
In this paper, we \change{describe an overview of the transactive sequence between different components of the systems. We also describe in the detail the structure of these transactions and show how these transactions}{propose \emph{Privacy-preserving Energy Transactions} (PETra), a distributed-ledger based solution that} (1) enables trading energy futures in a
