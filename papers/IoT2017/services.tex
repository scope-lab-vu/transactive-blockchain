...
Now, we will introduce anonymous communication service, mixing service for transaction anonymity, anonymous bid storage, and billing.\todo{Revise list based on final organization!}
...
\subsubsection{Billing and Microgrid Control}
