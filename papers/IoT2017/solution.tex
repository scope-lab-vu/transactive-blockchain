...
\todo{Remove the communication network and operating system}
\begin{figure}[h!]
\center
...
prosumer, as shown in Figure~\ref{fig:sellFlow}\Abhishek{We need to mention what is the expected deadline by which this sequence of task should finish. }. 
