...
This section describes Privacy-preserving Energy Transactions (PETra), our solution for providing privacy to prosumers
...
Proving ownership prevents the prosumer from ``spamming'' the storage service with bogus asks.
The prosumer can then
