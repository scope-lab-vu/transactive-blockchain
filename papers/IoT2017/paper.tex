...
\begin{figure*}[h]
\center
\begin{tikzpicture}[x=4.15cm, y=2cm, font=\small,
...
\end{tikzpicture}
\caption{Simplified overview of transactions for selling energy. Note that in order to prevent de-anonymization, a prosumer should use multiple addresses for mixing and multiple rounds of mixing.}
\end{figure*}
