...
grid.  This paper describes \change{our}{\emph{Privacy-preserving Energy Transactions} (PETra), a} secure and safe solution for
transactive microgrids, which enables consumers to trade energy
without sacrificing their privacy.  \change{Our solution}{PETra} builds on distributed
