...
\def\plaintitle{Providing Privacy, Safety, and Security in IoT-Based Transactive Energy Systems}
...
Within a transactive microgrid, consumers with energy generation and storage capabilities can trade energy with each other, thereby smoothing the load on the main grid using local supply.
However, providing security, safety, and privacy in a decentralized and transactive energy system is very challenging.
On the one hand, consumers' personal information must be protected from their trade partners and
\Abhishek{To what extent is this different that the information already known by the system operator? Is this more related to the ``real-time'' nature of transactive information? Rather than aggregative total information which is available at the end of billing cycle today.} \Aron{Do we need to detail this in the abstract?}\Abhishek{we dont have to} the system operator.
